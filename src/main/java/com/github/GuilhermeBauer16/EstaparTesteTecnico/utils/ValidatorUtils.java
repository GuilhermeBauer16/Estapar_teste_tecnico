...
import com.github.GuilhermeBauer16.EstaparTesteTecnico.exception.ValidationUtilsException;
...
public class ValidatorUtils {
    ...
    public <T, S> T updateFieldIfNotNull(T target, S source, String errorMessage, Class<? extends RuntimeException> customException) {
